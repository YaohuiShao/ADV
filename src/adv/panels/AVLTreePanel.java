...
public class AVLTreePanel extends Panel implements DocumentListener, ActionListener {
    ...
    public AVLTreePanel(Window window) {
        ...
        setUpLabels(removeLabel);
        removeLabel.setFont(f);
        removeField = new JTextField("");
        setTextField(removeField);
        ...
        setUpLabels(findLabel);
        findLabel.setFont(f);
        findField = new JTextField("");
        setTextField(findField);
       ...
       // this.add(box, BorderLayout.NORTH);
        this.add(view = AVLTreeView = new AVLTreeView(this));
    ...
    protected void setUpSkipButton(Box buttonsContainer) {
        ...
        //buttonsContainer.add(Box.createHorizontalStrut(100));
