...
public class HeapSortPanel extends Panel {
    ...
    public HeapSortPanel(Window window) {
        super(window);
    ...
    public HeapSortView getHeapSortView() {
        return heapSortView;
    }
