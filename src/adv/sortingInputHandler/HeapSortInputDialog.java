...
public class HeapSortInputDialog extends JDialog implements ItemListener, ActionListener, DocumentListener {
    ...
    private HeapSortPanel heapSortPanel;
    ...
    public static void main(String[] args) {
        try {
            HeapSortInputDialog dialog = new HeapSortInputDialog();
    ...
    public HeapSortInputDialog(HeapSortPanel heapSortPanel){
        this();
        this.heapSortPanel = heapSortPanel;
    }

    public HeapSortInputDialog() {
    ...
    private void generateUserInput() {
        ...
        heapSortPanel.getHeapSortView().setNewInput(numArray);
        heapSortPanel.enableGoAndSkip();
        this.dispose();
