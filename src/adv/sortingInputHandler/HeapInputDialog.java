...
import adv.panels.BuildHeapPanel;
...
public class HeapInputDialog extends JDialog implements ItemListener, ActionListener, DocumentListener {
    ...
    private BuildHeapPanel buildHeapPanel;
    ...
    public static void main(String[] args) {
        try {
            HeapInputDialog dialog = new HeapInputDialog();
    ...
    public HeapInputDialog(BuildHeapPanel buildHeapPanel){
        this();
        this.buildHeapPanel = buildHeapPanel;
    }

    public HeapInputDialog() {
    ...
    public void itemStateChanged(ItemEvent event) {
        ...
        if (event.getStateChange() == ItemEvent.SELECTED) {
            ...
            if (choiceSelected.equals(presetInputChoice)) {
                //ystem.out.println("PRESET-INPUT!");
    ...
    private void checkOptionSelected() {
        if (presetInputChoice.isSelected()) {
            ...
            buildHeapPanel.enableGoAndSkip();
            this.dispose();
    ...
    private void generateUserInput() {
        ...
        buildHeapPanel.getBuildHeapView().setNewInput(numArray);
        buildHeapPanel.enableGoAndSkip();
        this.dispose();
