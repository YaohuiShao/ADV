...
public abstract class SortView extends View {
    ...
    public SortView(SortPanel panel){
        showIndices = true;
        showBars = true;
        waitscalefactor = 10;
    ...
    public boolean greaterThan(int index1, int index2) {
        ...
        if (greaterThan) {
            panel.setLabel(arrayLocationValue[index1]+" > "+arrayLocationValue[index2]+", swap elements.");
            ...
            if (arrayLocationValue[index1] < arrayLocationValue[index2]) {
                panel.setLabel(arrayLocationValue[index1]+" < "+arrayLocationValue[index2]+", no swap required.");
                //displayMessage(arrayLocationValue[index1]+" < "+arrayLocationValue[index2]+", no swap required.");
            } else {
                panel.setLabel(arrayLocationValue[index2]+" = "+arrayLocationValue[index1]+", no swap required.");
    ...
    private void assignElements(int[] numArray) {
        ...
        for (int i = 0; i < currentNumElements; i++) {
            ...
            arrayLocationIndex[i] = createLabel(String.valueOf(i), Xpos[i], Ypos[i] + 22, false, font);
